...
#import "RYPortraitControlView.h"
#import "RYLandScapeControlView.h"
#import "RYPlayerMediaControl.h"
#import "RYSpeedLoadingView.h"

@interface RYPlayerControlView : UIView <RYPlayerMediaControl>


/// 竖屏控制层的View
@property (nonatomic, strong, readonly) RYPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) RYLandScapeControlView *landScapeControlView;

/// 加载loading
@property (nonatomic, strong, readonly) RYSpeedLoadingView *activity;

/// 快进快退View
@property (nonatomic, strong, readonly) UIView *fastView;

/// 快进快退进度progress
@property (nonatomic, strong, readonly) RYSliderView *fastProgressView;
...
/// 底部播放进度
@property (nonatomic, strong, readonly) RYSliderView *bottomPgrogress;
 ...
 */
- (void)showTitle:(NSString *)title coverURLString:(NSString *)coverUrl fullScreenMode:(RYFullScreenMode)fullScreenMode;
...
/**
 ...
 @param fullScreenMode 全屏模式
 */
- (void)showTitle:(NSString *)title coverURLString:(NSString *)coverUrl placeholderImage:(UIImage *)placeholder fullScreenMode:(RYFullScreenMode)fullScreenMode;
...
/**
 ...
 @param fullScreenMode 全屏模式
 */
- (void)showTitle:(NSString *)title coverImage:(UIImage *)image fullScreenMode:(RYFullScreenMode)fullScreenMode;
...
//设置分辨率名称
-(void)setDefaultUIWithURLNames:(NSMutableArray*)arr;



//添加字幕显示
//普通字幕
- (void)addNormalBarrage;//速度随机
//等速字幕
