...
@protocol RYSliderViewDelegate <NSObject>
...
@interface RYSliderButton : UIButton

@end

@interface RYSliderView : UIView

@property (nonatomic, weak) id<RYSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) RYSliderButton *sliderBtn;
